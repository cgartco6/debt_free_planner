...
def generate_financial_chart(schedule, output_path='output/debt_vs_savings.png'):
    ...
    Right Axis (Green): Traces compounding wealth portfolio growth.
    """
    ...
    ax2 = ax1.twinx()
    color = '#2e7d32'
    ax2.set_ylabel('Compounding Investment Portfolio Wealth (R)', color=color, fontweight='bold')
    line2 = ax2.plot(months, savings, color=color, linewidth=2.5, linestyle='--', label='Compounding Wealth Account')
    ...
    plt.title('Inflation-Adjusted Debt Extinction & Portfolio Wealth Engine Map', 
